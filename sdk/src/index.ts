...
export default class DevoltClient {
    ...
    async batteryReport() {
        ...
        const d = await this.program.methods
            .batteryReport({
                id: '3',
                latitude: 0,
                longitude: 0,
...
const secretArray: number[] = [59, 82, 131, 25, 97, 163, 16, 56, 89, 160, 64, 28, 241, 28, 188, 186, 21, 131, 230, 113, 252, 100, 208, 60, 137, 240, 43, 85, 254, 217, 68, 149, 163, 5, 193, 216, 243, 33, 223, 130, 145, 9, 117, 106, 254, 86, 171, 115, 255, 3, 202, 13, 71, 103, 142, 162, 238, 169, 164, 211, 45, 242, 230, 132];
const secret: Uint8Array = new Uint8Array(secretArray);
const secretHex: string = Array.from(secret).map(b => b.toString(16).padStart(2, '0')).join('');
